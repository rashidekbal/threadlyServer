...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2025 at 08:47 PM
...
('kaluadon', 'Rani', 'rtechdevlopment123@gmail.com', NULL, '$2b$12$a9xomUz7XKvn/BYKgiXJD.1RjeKoFbEgoZNR9rUXY8c/HM1bg4zlq', '💻 Dev Vibe:\nAndroid dev ⚙️ | Java ❤️ | Building things that matter\n🎧 Soft + Poetic:\nCode in my veins, silence in my soul 🌌\n🔥 Flirty + Cool', 'https://res.cloudinary.com/dphwlcyhg/image/upload/v1754564929/exliaf9par4b8yjvdtrn.jpg', '2025-06-01', '2025-06-22 15:31:49', '710b962e-041c-11e1-9234-5123456789ab', 'caz-xei6TlO3yFYPIWo6aA:APA91bHaYLO8Wa2VttDZGaX9BQ7YiOAiHY_S09sEOmpbLI_u-KVexpH60l8hmySlHab0zyLnTYZlfsxfuE-iFvbspsgjzKYzHHHEgtvTsummPS-dU9RUD1A'),
('Mysterious_being', 'mysterious devil', NULL, '9123481953', '$2a$10$rKG82muePaAXJNpXstVW0.GDeX8jtn1Dfq8FGSN4F40HeRVyk3Azm', '💻 Android Dev 💥\n ☕ Java Junkie \n 🚀 Dreamin’ big, building bigger\n ⚡ Hustle > Hype\n🧠 Engineer Mode: ON', 'https://res.cloudinary.com/dphwlcyhg/image/upload/v1754564883/vziiwfxvnrj3ouhwcq42.png', '2025-05-11', '2025-05-11 23:00:44', '710b962e-041c-11e1-9234-5123456709ab', 'dWCboA7JQzGzZWY-73WlM6:APA91bHO9Y5wqX2tskoFyajmTM8DoCIj5ZNOi_gztYiy2hcLRsNTks-joGYOxi3tQ_bvY4GrGDkKWz2KQRUyViUAoGG9FWvaIY33Qyup2r5Tx_hINEfJ_ig');
...
ALTER TABLE `messages`
  ...
  ADD UNIQUE KEY `uq_messageUid` (`messageUid`),
  ADD KEY `senderUUId` (`senderUUId`),
  ADD KEY `recieverUUId` (`recieverUUId`);
...
--
ALTER TABLE `messages`
  MODIFY `messageId` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `post_likes`
  MODIFY `likeid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=220;
